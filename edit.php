                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="company" value="<?php echo $comapny ?>" >
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    <div class="col-3">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="area_code" value="<?php echo $Areacode ?>">
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="subject" id="subject" required>
                                            <option name="subject" disabled="disabled" selected="selected" >Choose option</option>
                        ...
                        <div class="form-row p-t-20">
                            ...
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">Yes
                                    <input type="radio" checked="checked" value="1" name="exist" required>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="radio-container">No
                                    <input type="radio" name="exist" value="0" required>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
